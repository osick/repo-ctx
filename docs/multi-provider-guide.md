...
await use_mcp_tool("repo-ctx", "ctx-index", {
...
await use_mcp_tool("repo-ctx", "ctx-search", {
  query: "fastapi",
  limit: 10
});

// Get documentation (works for any indexed repo)
await use_mcp_tool("repo-ctx", "ctx-docs", {
  repository: "/fastapi/fastapi"  // GitHub repo
});

await use_mcp_tool("repo-ctx", "ctx-docs", {
  repository: "/mygroup/myproject"  // GitLab repo
});
```
...
- [User Guide](user_guide.md) - Installation, CLI, MCP usage
